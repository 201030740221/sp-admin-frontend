  ...
  Sortable.prototype = /** @lends Sortable.prototype */ {
    ...
    _onTouchMove: function ( /**TouchEvent*/ evt) {
      if (tapEvt) {
        var touch = evt.touches ? evt.touches[0] : evt,
          ...
          translate3d = evt.touches ? 'translate3d(' + dx + 'px,' + dy + 'px,0)' : 'translate(' + dx + 'px,' + dy +
          'px)';
      ...
      if (activeGroup && !options.disabled &&
        ...
        if ((el.children.length === 0) || (el.children[0] === ghostEl) ||
          ...
          var targetRect = target.getBoundingClientRect(),
            ...
            halfway = (floating ? (evt.clientX - targetRect.left) / width : (evt.clientY - targetRect.top) /
              height) > 0.5,
    ...
    _animate: function (prevRect, target) {
      ...
      if (ms) {
        ...
        _css(target, 'transform', 'translate3d(' + (prevRect.left - currentRect.left) + 'px,' + (prevRect.top -
          currentRect.top) + 'px,0)');
