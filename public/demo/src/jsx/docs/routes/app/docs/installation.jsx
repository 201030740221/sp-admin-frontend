                ...
                <Panel>
                  ...
                  <PanelBody>
                    <Grid>
                      <Row>
                        <Col xs={12}>
                          <p>{"We have included a pre-built demo which you can find in the "}<strong>rubix-static</strong>{" directory. You can just drop this directory into a local server of your choice (like Apache/Nginx/Lighthttpd etc) and navigate around to see if the demo works as expected. Note that some features in X-Editable's AJAX demo does not work with this setup."}</p>
                          <p>
