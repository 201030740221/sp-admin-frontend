                    ...
                    <Grid>
                      <Row>
                        <Col xs={12}>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div>
                                    <small><em><strong>Usage: </strong><span></span>gulp --port 3000</em></small>
                                  </div>
                                </td>
                                <td>
                                  <div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div>
                                    <p>{"A boolean flag like "}<strong>{"--rtl"}</strong>{". Run this when you are done with development as it compiles, minifies and bundles all the source CSS and JS files. For bundling external plugins please consult "}<strong><Link href='/app/docs/gulpfile/externalplugins'>Gulpfile.js > External Plugins</Link></strong>{" doc page."}</p>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
                          ...
                          <div>
                            <Img responsive src='public/imgs/shots/gulp-options-terminal.png' />
                          </div>
                          <br/>
                        </Col>
                      </Row>
