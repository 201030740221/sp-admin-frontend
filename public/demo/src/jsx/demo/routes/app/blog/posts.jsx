            ...
            <Grid>
              <Row>
                <Col xs={12}>
                    ...
                    <Row>
                      <Col xs={6} collapseLeft collapseRight>
                        <div className='fg-darkgray50'>
                          <small>by <Link href='/app/blog/post'>{this.props.author}</Link> / {this.props.date}</small>
                        </div>
                      </Col>
                  ...
                  <p>
                    <Link href='/app/blog/post'>Read More</Link>
                  </p>
                </Col>
              </Row>
            </Grid>
                    ...
                    <PanelContainer noControls>
                      <Panel horizontal>
                        ...
                        <PanelRight className='bg-yellow' style={{verticalAlign: 'middle', padding: 12.5, width: 80}}>
                          <div className='text-center'><Img src='public/imgs/avatars/avatar0.png' width='40' height='40' style={{borderRadius: 100}} /></div>
                        </PanelRight>
                      </Panel>
                    </PanelContainer>
                          ...
                          <Row>
                            <Col xs={12} className='text-center'>
                              <div className='text-left'>
                                ...
                                <div style={{marginBottom: 12.5}}>
                                  <Link href='/app/blog/post'><LoremIpsum className='text-capitalize' query='3w'/></Link>
                            ...
                            <Row>
                              <Col xs={12}>
                                <div>
                                  ...
                                  <Avatar src='public/imgs/avatars/avatar5.png'>Jordyn Ouellet</Avatar>
                                  <Avatar src='public/imgs/avatars/avatar9.png'>Ava Parry</Avatar>
                                  <Avatar src='public/imgs/avatars/avatar10.png'>Angelina Mills</Avatar>
                                  <Avatar src='public/imgs/avatars/avatar7.png'>Toby King</Avatar>
                                </div>
                              </Col>
                            </Row>
                          </Grid>
