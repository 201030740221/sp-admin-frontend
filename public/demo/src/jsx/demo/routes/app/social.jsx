...
var SocialBanner = React.createClass({
  ...
  render: function() {
    return (
      <div style={{height: 350, marginTop: -25, backgroundImage: 'url(public/imgs/shots/Blick_auf_Manhattan.JPG)', backgroundSize: 'cover', position: 'relative', marginBottom: 25, backgroundPosition: 'center'}}>
          ...
          <Row>
                  ...
                  <Grid>
                    <Row>
                      <Col xs={6} collapseLeft collapseRight>
                        <Link href='#' style={{border: 'none'}}><Icon glyph='icon-dripicons-location icon-1-and-quarter-x fg-text' style={{marginRight: 25}} /></Link>
                        <Link href='#' style={{border: 'none'}}><Icon glyph='icon-dripicons-camera icon-1-and-quarter-x fg-text' style={{marginRight: 25}} /></Link>
                        <Link href='#' style={{border: 'none'}}><Icon glyph='icon-dripicons-calendar icon-1-and-quarter-x fg-text' style={{marginRight: 25}} /></Link>
                      </Col>
              ...
              <PanelContainer>
                <PanelBody style={{padding: 25, paddingTop: 12.5}}>
                  <div className='inbox-avatar'>
                    <img src='public/imgs/avatars/avatar7.png' width='40' height='40' />
                  ...
                  <div style={{margin: -25, marginTop: 25}}>
                    <Img responsive src='public/imgs/gallery/tumblr_n8zm8ndGiY1st5lhmo1_1280.jpg' />
                  </div>
                </PanelBody>
                <PanelFooter className='fg-black75 bg-gray' style={{padding: '12.5px 25px', margin: 0}}>
                  <Grid className='fg-text'>
                    <Row>
                      <Col xs={6} collapseLeft collapseRight>
                        <Link href='#' className='fg-text' style={{border: 'none', marginRight: 25}}><Icon glyph='icon-dripicons-thumbs-up icon-1-and-quarter-x' /><span style={{position: 'relative', top: -2, left: 3}}>Like</span></Link>
                      </Col>
                      <Col xs={6} className='text-right' collapseLeft collapseRight>
                ...
                <PanelFooter style={{padding: 25, paddingTop: 0, paddingBottom: 0}}>
                  <div className='inbox-avatar' style={{borderBottom: '1px solid #EAEDF1'}}>
                    <img src='public/imgs/avatars/avatar0.png' width='30' height='30' style={{verticalAlign: 'top', top: 10, position: 'relative'}} />
                    <div className='inbox-avatar-name'>
                  ...
                  <div className='inbox-avatar' style={{borderBottom: '1px solid #EAEDF1'}}>
                    <img src='public/imgs/avatars/avatar9.png' width='30' height='30' style={{verticalAlign: 'top', top: 10, position: 'relative'}} />
                    <div className='inbox-avatar-name'>
                  ...
                  <div className='inbox-avatar' style={{borderBottom: '1px solid #EAEDF1'}}>
                    <img src='public/imgs/avatars/avatar7.png' width='30' height='30' style={{verticalAlign: 'top', top: 10, position: 'relative'}} />
                    <div className='inbox-avatar-name'>
                      <div className='fg-darkgrayishblue75'>Ava Parry</div>
            ...
            <Col sm={6}>
              <PanelContainer>
                <PanelBody style={{padding: 25, paddingTop: 12.5}}>
                  <div className='inbox-avatar'>
                    <img src='public/imgs/avatars/avatar5.png' width='40' height='40' />
                    <div className='inbox-avatar-name'>
              ...
              <PanelContainer>
                <PanelBody style={{padding: 25, paddingTop: 12.5}}>
                  <div className='inbox-avatar'>
                    <img src='public/imgs/avatars/avatar9.png' width='40' height='40' />
                    <div className='inbox-avatar-name'>
                      <div className='fg-darkgrayishblue75'>Ava Parry</div>
