  ...
  getLongModal: function() {
    return (
      <Modal>
        ...
        <ModalBody>
          <p>
            <img src='public/imgs/longmodal.jpg' />
          </p>
        </ModalBody>
        <ModalFooter>
          <Button outlined bsStyle='danger' onClick={ModalManager.remove} onTouchEnd={ModalManager.remove}>Close</Button>
    ...
    return (
      <Modal onShown={modalVisible}>
        ...
        <ModalBody>
          ...
          <p>
            <Link href='#' title='Tooltip' data-toggle='tooltip' data-placement='top'>This link</Link> and <Link href='#' title='Tooltip' data-toggle='tooltip' data-placement='top'>that link</Link> should have tooltips on hover.
          </p>
