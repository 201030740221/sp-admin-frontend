                  ...
                  <PanelBody>
                    <Grid>
                      <Row>
                        <Col xs={12}>
                          <br/>
                          <div><img src='public/imgs/wefunction/020.jpg' ref='target' alt='[Jcrop example]' width='100%' height='350' /></div>
                          <br/>
                          <p>
                            <strong>
                  ...
                  <PanelBody>
                    <Grid>
                      <Row>
                        <Col xs={12}>
                          <br/>
                          <div><img src='public/imgs/unsplash/parie.jpg' ref='eventtarget' alt='[Jcrop example]' width='100%' height='350' /></div>
                          <br/>
                          <Form id="coords"
                            className="coords">
                          ...
                          <Grid>
                            <Row>
                              <Col sm={8} collapseLeft collapseRight>
                                <img src='public/imgs/unsplash/hot-air-baloon.jpg' ref='aspectwithpreview' alt='[Jcrop example]' width='100%' height='350' />
                              </Col>
                              <Col sm={4} collapseLeft collapseRight>
                                <div id='preview-pane' style={{display: 'block', position: 'absolute', zIndex: 2000, top: 10, right: '-250px', padding: 6, border: '1px rgba(0,0,0,.4) solid', background: 'white', borderRadius: 6}}>
                                  <div className='preview-container' style={{width: 225, height: 170, overflow: 'hidden'}}>
                                    <img src='public/imgs/unsplash/hot-air-baloon.jpg' alt='[Jcrop example]' className='jcrop-preview' alt='Preview' width='100%' />
                                  </div>
                                </div>
                              </Col>
                            </Row>
                          ...
                          <Grid>
                            <Row>
                              <Col sm={7} collapseLeft collapseRight>
                                <div><img src='public/imgs/wefunction/020.jpg' ref='animationstransitions' alt='[Jcrop example]' width='100%' height='350' /></div>
                                <br/>
                                <div className="description">
