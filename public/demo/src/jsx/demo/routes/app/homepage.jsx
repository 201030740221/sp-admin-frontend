      ...
      <Container id='homepage-container'>
        ...
        <div>
          <Hero className='text-center hidden-xs' style={{height: 475, backgroundImage: 'url(public/imgs/homepage/background.png)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', overflow: 'hidden'}}>
            <img src='public/imgs/homepage/simplepowerful.png' style={{marginTop: 5}} />
          </Hero>
          <Hero className='text-center visible-xs' style={{height: 270, backgroundImage: 'url(public/imgs/homepage/background.png)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', overflow: 'hidden'}}>
            <img width='270' className='visible-xs' src='public/imgs/homepage/simplepowerful.png' style={{margin: 'auto', marginTop: 30}} />
          </Hero>
        </div>
        <Hero>
            ...
            <Row>
              ...
              <Col sm={5} collapseLeft collapseRight>
                <div className='hidden-xs text-right'>
                  <img src='public/imgs/homepage/reactcode.png' />
                </div>
                <div className='visible-xs text-center'>
                  <img width='250' src='public/imgs/homepage/reactcode.png' />
                </div>
              </Col>
            </Row>
          </Grid>
        ...
        <Hero>
          ...
          <div className='text-center' style={{marginTop: 25, marginBottom: 25}}>
            <div className='hidden-xs'>
              <img src='public/imgs/homepage/bootstrapreact.png' />
            </div>
            <div className='visible-xs'>
              <img width='250' src='public/imgs/homepage/bootstrapreact.png' />
            </div>
          </div>
        ...
        <Hero>
          ...
          <div className='text-center' style={{marginTop: 25, marginBottom: 25}}>
            <div className='hidden-xs'>
              <img src='public/imgs/homepage/mozflags.png' />
            </div>
            <div className='visible-xs'>
              <img width='250' src='public/imgs/homepage/mozflags.png' />
            </div>
          </div>
          <p className='text-center'>
        ...
        <Hero>
          ...
          <div className='text-center' style={{marginTop: 25, marginBottom: 25}}>
            <div className='hidden-xs'>
              <img src='public/imgs/homepage/rubixcharts.png' />
            </div>
            <div className='visible-xs'>
              <img width='250' src='public/imgs/homepage/rubixcharts.png' />
            </div>
          </div>
          <p className='text-center'>
        ...
        <Hero>
          ...
          <div className='text-center' style={{marginTop: 25, marginBottom: 25}}>
            <div className='hidden-xs'>
              <img src='public/imgs/homepage/panels.png' />
            </div>
            <div className='visible-xs'>
              <img width='250' src='public/imgs/homepage/panels.png' />
            </div>
          </div>
          <p className='text-center'>
        ...
        <Hero style={{position: 'relative', zIndex: 2}}>
          ...
          <div className='text-center' style={{marginTop: 25, marginBottom: 25}}>
            <div className='hidden-xs'>
              <img src='public/imgs/homepage/assetpipeline.png' />
            </div>
            <div className='visible-xs'>
              <img width='250' src='public/imgs/homepage/assetpipeline.png' />
            </div>
          </div>
          <p className='text-center'>
        ...
        <Hero className='subtle-bottom-shadow'>
          ...
          <div className='text-center' style={{marginTop: 25, marginBottom: 25}}>
            <img src='public/imgs/homepage/support.png' />
          </div>
          <p className='text-center'>
