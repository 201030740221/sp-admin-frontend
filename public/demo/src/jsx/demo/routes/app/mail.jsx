                      ...
                      <PanelBody className='panel-sm-9 panel-xs-12'>
                        <Grid>
                          <Row>
                            <Col xs={12}>
                              <div className='inbox-avatar'>
                                <img src='public/imgs/avatars/avatar5.png' width='40' height='40' className='border-green hidden-xs' />
                          ...
                          <Row>
                            <Col xs={12}>
                              ...
                              <p className='inbox-attachments'>
                                ...
                                <Link className='inbox-attachment-download' href='#'>Download</Link>
                              </p>
                              <p className='inbox-attachments'>
