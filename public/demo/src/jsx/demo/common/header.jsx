...
var Brand = React.createClass({
  render: function() {
    return this.transferPropsTo(
      <NavHeader>
        <NavBrand tabIndex='-1'>
          <img src='public/imgs/logo.png' alt='rubix' width='111' height='28' />
        </NavBrand>
      </NavHeader>
    );
  }
    ...
    return (
      <MenuItem flag={this.props.flag} locale={this.props.locale} parent={this.props.parent} href='#' active={this.props.active}>
        <Grid>
          <Row>
            <Col xs={2}>
              <img src={'public/imgs/flags/flags/flat/32/'+this.props.flag+'.png'} width='32' height='32' />
            </Col>
            <Col xs={10}>
        ...
        <Nav className='hidden-xs'>
          ...
          <NavItem dropdown>
            <DropdownButton id='flag-menu-btn' nav toggleOnHover container={this} menu='flag-menu'>
              <img src={'public/imgs/flags/flags/flat/32/' + this.state.selectedFlag + '.png'} width='32' height='32' />
            </DropdownButton>
            ...
            <Menu alignRight noTimer id='notifications-menu' ref='bullhorn-menu' className='double-width' alwaysInactive>
                ...
                <Grid>
                  <Row>
                    <Col xs={2} className='avatar-container' collapseRight>
                      <div><img src='public/imgs/avatars/avatar22.png' width='40' height='40' alt='sarah_patchett' /></div>
              ...
              <MenuItem href='#'>
                <Grid>
                  <Row>
                    <Col xs={2} className='avatar-container' collapseRight>
                      <img src='public/imgs/avatars/avatar21.png' width='40' height='40' alt='john_young' />
                    </Col>
                    <Col xs={10} className='notification-container' collapseLeft collapseRight>
                      <div className='time'>
              ...
              <MenuItem href='#'>
                <Grid>
                  <Row>
                    <Col xs={2} className='avatar-container' collapseRight>
                      <div><img src='public/imgs/github.png' width='40' height='40' alt='github' /></div>
                      <div className='text-center'>
