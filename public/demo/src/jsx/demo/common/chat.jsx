...
var ChatItem = React.createClass({
  ...
  render: function() {
    ...
    return this.transferPropsTo(
      <li name={null} tabIndex='-1'>
        <Link href={'#'} name={null} tabIndex='-1'>
          <img src={'public/imgs/avatars/'+this.props.avatar+'.png'} width='30' height='30' className={status} style={{borderWidth: 2, borderStyle: 'solid', borderRadius: 100, padding: 2, position: 'relative', top: -7, opacity: isOffline ? 0.4 : 1}} />
